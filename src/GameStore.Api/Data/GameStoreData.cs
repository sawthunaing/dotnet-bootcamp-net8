...
public class GameStoreData
{
    ...
    [
        new Genre {Id = new Guid("15379cc4-a315-44d1-b5b6-c575dcaf0d87"), Name = "Fighting"},
        new Genre {Id = new Guid("5848aecd-785a-45de-b3fb-1fac8f5794c1"), Name = "Kids and Family"},
        new Genre {Id = new Guid("55cb41d4-c3c2-4dfd-80ce-3274998a5fe7"), Name = "Racing"},
        new Genre {Id = new Guid("dfac6bbb-52b8-4366-aed7-3f6feef3704c"), Name = "Roleplaying"},
        new Genre {Id = new Guid("d1e02a21-e00e-49fb-a5c7-1c80d85f97ac"), Name = "Sports"},
